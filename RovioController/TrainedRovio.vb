...
Public Class TrainedRovio
  ...
  Private Sub CreateGrammar()
    ...
    CommType.Add("Rovio", "Bark", "Hello", "Run forward", "Good dog", "Move left", "Move right", "Go back", "Go backwards", "Move back", "Go forward", "Move forward", "Slide left", "Slide right", "Turn around", "Turn left", "Turn right", "Spin", "Spin around", "Wander", "Speak", "Move backwards", "Move up", "Good bye", "Exit", "Sit up", "Down boy", "Down girl", "Go Crazy")
