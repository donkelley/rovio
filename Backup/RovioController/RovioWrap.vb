...
#End Region
  ...
  Public Sub Say(ByVal TextToSpeak As String, _
    ...
    Try
      ...
      Dim remoteEndPoint As IPEndPoint = New System.Net.IPEndPoint(System.Net.IPAddress.Parse(RovioIP), RovioPort)
      ...
      Dim temp1 As String = "POST /GetAudio.cgi HTTP/1.1" & vbCrLf & "User-Agent: AudioAgent" & vbCrLf & "Host: " & RovioIP & vbCrLf & "Content-Length: 2147483647" & vbCrLf & "Cache-Control: no-cache" & vbCrLf & vbCrLf
      Dim szSend() As Byte
...
#Region "RTSP Streaming Microphone Audio to Speech Recognition or to WAV file"
  ...
  Public Function StartAudioStream() As System.IO.Stream
    ...
    remoteAudioStreamEndPoint = New System.Net.IPEndPoint(System.Net.IPAddress.Parse(RovioIP), 554)
    rovioAudioStreamSocket.Connect(remoteAudioStreamEndPoint)
    Debug.Print(Now & " : Audio STREAM Input socket connected")
    '// Prepare the audio port for sending audio from the PC back to the Rovio

    Dim Send01 As String = "DESCRIBE rtsp://" & RovioIP & "/webcam RTSP/1.0" & vbCrLf & "CSeq : " & RequestCount & vbCrLf & _
    ...
    Dim Send02 As String = "SETUP rtsp://" & RovioIP & "/webcam/track1 RTSP/1.0" & vbCrLf & "CSeq : " & RequestCount & vbCrLf & _
    ...
    Dim Send03 As String = "PLAY rtsp://" & RovioIP & "/webcam RTSP/1.0" & vbCrLf & "CSeq : " & RequestCount & vbCrLf & _
  ...
  Public Sub StopAudioStream()
    ...
    Dim Send04 As String = "TEARDOWN rtsp://" & RovioIP & "/webcam RTSP/1.0" & vbCrLf & "CSeq : " & RequestCount & vbCrLf & _
